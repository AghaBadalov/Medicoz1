...
namespace Medicoz.Areas.manage.Controllers
{
    ...
    public class AppointmentController : Controller
    {
        ...
        public IActionResult Reject(int id)
        {
            ...
            _emailService.Send(appointment.Email, "Your Appointment has been cancelled", "Sorry ");
        ...
        public IActionResult Accept(int id)
        {
            ...
            _emailService.Send(appointment.Email, "Your Appointment has been accepted", "Thank you ");
            _context.SaveChanges();
            return RedirectToAction("index");
